...
@authenticate
async def get1(storage_service_id: str, storage_pool_id: str) -> StoragePool:
...
@authenticate
async def get5(storage_service_id: str, volume_id: str, storage_pool_id: str) -> StoragePool:
    s: Service = find_service(StoragePool)
    b: dict[str, Any] = {
        "storage_service_id": storage_service_id,
        "volume_id": volume_id,
...
@authenticate
async def get7(storage_id: str, storage_pool_id: str) -> StoragePool:
    s: Service = find_service(StoragePool)
...
@authenticate
async def get8(storage_id: str, storage_pool_id: str, allocated_pool_id: str) -> StoragePool:
    s: Service = find_service(StoragePool)
    b: dict[str, Any] = {
...
@authenticate
async def get11(storage_id: str, volume_id: str, storage_pool_id: str) -> StoragePool:
    s: Service = find_service(StoragePool)
    b: dict[str, Any] = {
        "storage_id": storage_id,
        "volume_id": volume_id,
...
@authenticate
async def get13(computer_system_id: str, storage_id: str, storage_pool_id: str) -> StoragePool:
    s: Service = find_service(StoragePool)
    b: dict[str, Any] = {
