...
from ...model.swordfish.data_security_line_of_service import (
    DataSecurityLineOfService,
    DataSecurityLineOfServiceOnUpdate,
)
...
async def delete1(
    ...
    s: Service = get_service(DataSecurityLineOfService, request)
    b: dict[str, Any] = {
...
async def get1(
    ...
    m = cast(DataSecurityLineOfService, s.get(**b))
...
async def patch1(
    ...
    request: Request,
    response: Response,
    body: DataSecurityLineOfServiceOnUpdate,
) -> DataSecurityLineOfService:
    s: Service = get_service(DataSecurityLineOfService, request)
    b: dict[str, Any] = {
        "storage_service_id": storage_service_id,
    ...
    return cast(DataSecurityLineOfService, s.patch(**b))
