...
@authenticate
async def get1(storage_service_id: str) -> StorageGroupCollection:
...
@authenticate
async def get2(storage_service_id: str, volume_id: str) -> StorageGroupCollection:
    s: Service = find_service(StorageGroupCollection)
...
@authenticate
async def get3(storage_id: str) -> StorageGroupCollection:
    s: Service = find_service(StorageGroupCollection)
...
@authenticate
async def get4(storage_id: str, volume_id: str) -> StorageGroupCollection:
    s: Service = find_service(StorageGroupCollection)
