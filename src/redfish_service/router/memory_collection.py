...
@authenticate
async def get1(computer_system_id: str) -> MemoryCollection:
...
@authenticate
async def get2(computer_system_id: str, processor_id: str) -> MemoryCollection:
    s: Service = find_service(MemoryCollection)
...
@authenticate
async def get3(chassis_id: str) -> MemoryCollection:
    s: Service = find_service(MemoryCollection)
...
@authenticate
async def get4(resource_block_id: str, computer_system_id: str) -> MemoryCollection:
    s: Service = find_service(MemoryCollection)
    b: dict[str, Any] = {
...
@authenticate
async def get5(resource_block_id: str, computer_system_id: str) -> MemoryCollection:
    s: Service = find_service(MemoryCollection)
    b: dict[str, Any] = {
        "resource_block_id": resource_block_id,
        "computer_system_id": computer_system_id,
