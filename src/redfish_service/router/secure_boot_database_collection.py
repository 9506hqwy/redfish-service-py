...
@authenticate
async def get1(computer_system_id: str) -> SecureBootDatabaseCollection:
...
@authenticate
async def get2(resource_block_id: str, computer_system_id: str) -> SecureBootDatabaseCollection:
    s: Service = find_service(SecureBootDatabaseCollection)
    b: dict[str, Any] = {
...
@authenticate
async def get3(resource_block_id: str, computer_system_id: str) -> SecureBootDatabaseCollection:
    s: Service = find_service(SecureBootDatabaseCollection)
    b: dict[str, Any] = {
        "resource_block_id": resource_block_id,
        "computer_system_id": computer_system_id,
