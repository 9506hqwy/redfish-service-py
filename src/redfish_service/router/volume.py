...
@authenticate
async def get1(resource_block_id: str, storage_id: str, volume_id: str) -> Volume:
...
@authenticate
async def get3(resource_block_id: str, storage_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
        "resource_block_id": resource_block_id,
        "storage_id": storage_id,
...
@authenticate
async def get5(storage_id: str, consistency_group_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
        "storage_id": storage_id,
...
@authenticate
async def get7(storage_id: str, storage_pool_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
        "storage_id": storage_id,
...
@authenticate
async def get9(storage_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
...
@authenticate
async def get14(computer_system_id: str, storage_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
        "computer_system_id": computer_system_id,
        "storage_id": storage_id,
...
@authenticate
async def get15(storage_service_id: str, consistency_group_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
...
@authenticate
async def get17(storage_service_id: str, storage_pool_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
    b: dict[str, Any] = {
        "storage_service_id": storage_service_id,
        "storage_pool_id": storage_pool_id,
...
@authenticate
async def get19(storage_service_id: str, volume_id: str) -> Volume:
    s: Service = find_service(Volume)
