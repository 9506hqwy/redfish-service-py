...
class CoolingUnitOnUpdate(RedfishModel):
    odata_context: str | None = Field(alias="@odata.context", default=None)
    odata_etag: str | None = Field(alias="@odata.etag", default=None)
    odata_id: str | None = Field(alias="@odata.id", default=None)
    odata_type: str | None = Field(alias="@odata.type", default="#CoolingUnit.v1_1_2.CoolingUnit")
    actions: Actions | None = None
    assembly: IdRef | None = None
    asset_tag: str | None = None
    coolant: Coolant | None = None
    ...
    description: str | None = None
    environment_metrics: IdRef | None = None
    equipment_type: CoolingEquipmentType | None = None
    filter_redundancy: list[RedundantGroup] | None = None
    filters: IdRef | None = None
    firmware_version: str | None = None
    id: str | None = None
