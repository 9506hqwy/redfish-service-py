...
class Cable(RedfishModel):
    ...
    odata_type: str = Field(serialization_alias="@odata.type", default="#Cable.v1_3_0.Cable")
...
class CableOnCreate(RedfishModel):
    ...
    odata_type: str | None = Field(
        serialization_alias="@odata.type", default="#Cable.v1_3_0.Cable"
    )
    actions: Actions | None = None
    assembly: IdRef | None = None
    asset_tag: str | None = None
...
class CableOnUpdate(RedfishModelOnUpdate):
    actions: Actions | None = None
    asset_tag: str | None = None
    cable_class: CableClass | None = None
    cable_status: CableStatus | None = None
