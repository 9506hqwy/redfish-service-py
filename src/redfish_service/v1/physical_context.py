...
class PhysicalContext(StrEnum):
    ...
    LOWER = "Lower"
    CPU = "CPU"
    CPU_SUBSYSTEM = "CPUSubsystem"
    GPU = "GPU"
    GPU_SUBSYSTEM = "GPUSubsystem"
    FPGA = "FPGA"
    ...
    AC_UTILITY_INPUT = "ACUtilityInput"
    AC_STATIC_BYPASS_INPUT = "ACStaticBypassInput"
    AC_MAINTENANCE_BYPASS_INPUT = "ACMaintenanceBypassInput"
    DC_BUS = "DCBus"
    AC_OUTPUT = "ACOutput"
    AC_INPUT = "ACInput"
